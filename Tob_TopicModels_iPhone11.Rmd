...
commonWords <- c("iphone", "phone", "apple", "iPhone", "camera")
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 1 seems to be about iPhone 11 Battery Life",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 3 seems to be about upgrading to the iPhone 11",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 5 seems to be about switching from Android iPhone 11",
    x = "word",
    y = "beta"
  ) +
  theme(
...
tmpDF <- data.frame(
  topic = c(1, 3, 5),
  theLabels = c("Battery Life", "Upgrading Phone", "Android to iPhone 11")
)
