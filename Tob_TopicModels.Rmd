...
theTopicsTop %>%
  ...
  scale_x_continuous(breaks = TopicsTop$x,
                     labels = TopicsTop$term,
                     expand = c(0,0)) + 
  labs(title=paste0('Top Words in Topic ',theTopic, ' Word Distribution'),  caption = 'Topic 2 seems to be about how it is easy to switch from Android to iPhone 8',
       x = 'word',
       y = 'beta')+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size=5),
...
theTopicsTop %>%
  ...
  scale_x_continuous(breaks = TopicsTop$x,
                     labels = TopicsTop$term,
                     expand = c(0,0)) + 
  labs(title=paste0('Top Words in Topic ',theTopic, ' Word Distribution'),  caption = 'Topic 2 seems to be about how it is easy to switch from Android to iPhone X',
       x = 'word',
       y = 'beta')+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size=5),
        axis.text.y = element_text(size = 8))
...
theTopicsTop %>%
  ...
  scale_x_continuous(breaks = TopicsTop$x,
                     labels = TopicsTop$term,
                     expand = c(0,0)) + 
  labs(title=paste0('Top Words in Topic ',theTopic, ' Word Distribution'),  caption = 'Topic 5 seems to be about the Home Button Retention of the iPhone X',
       x = 'word',
       y = 'beta')+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size=5),
        axis.text.y = element_text(size = 8))
...
theTopicsTop %>%
  ...
  scale_x_continuous(breaks = TopicsTop$x,
                     labels = TopicsTop$term,
                     expand = c(0,0)) + 
  labs(title=paste0('Top Words in Topic ',theTopic, ' Word Distribution'),  caption = 'Topic 9 seems to be about the Wireless Charging capabilities of the iPhone X',
       x = 'word',
       y = 'beta')+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size=5),
        axis.text.y = element_text(size = 8))
